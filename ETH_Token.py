...
class test_tokens():
            ...
            try:
                ...
                if(count > 100):
                    for page in range(0,int(int(count)/100)+1) :
                        ...
                        my_pages.prettify()
                        datasNames = []
                        tbodys = my_pages.find('table',id="table-subcatid-0").find('tbody')
                    ...
                    if trs2:
                        try:
                            for tr2 in trs2:
                                ...
                                token_nameTag11 = tr2.find('span', class_="text-truncate")
                                token_nameTag21 = tr2.find('span', class_="text-muted")
                                token_nameTag31 = tr2.find('span', class_="hash-tag text-truncate")
                                ...
                                if token_nameTag11 is None:
                                    if token_nameTag21 is None:
                                        if token_nameTag31 is not None:
                                            dataNamedit2["token_nameTag"] = token_nameTag31.get_text()
                                    else:
                                        dataNamedit2["token_nameTag"] = token_nameTag31.get_text() + token_nameTag21.get_text()
                                else:
                                    if token_nameTag21 is None:
                                        dataNamedit2["token_nameTag"] = token_nameTag11.get_text()
                                    else:
                                        dataNamedit2["token_nameTag"] = token_nameTag11.get_text() + token_nameTag21.get_text()
    ...
    def login(self):
        try:
            ...
            ele1 = "/html[@id='html']/body[@id='body']/main[@id='content']/section[@class='container-xxl pt-5 pb-12']/div[@id='ContentPlaceHolder1_divTokenByLabels']/div[@class='tab-content']/div[@id='tab-1-content']/div[@class='card']/div[@class='table-responsive']/div[@id='table-subcatid-1_wrapper']/div[@class='d-flex flex-wrap align-items-center justify-content-between gap-3 p-4 text-dark']/div[@id='table-subcatid-1_paginate']/ul[@class='pagination pagination-sm mb-0']/li[@id='table-subcatid-1_next']/a[@class='page-link px-3']"
            ele3 = "/html[@id='html']/body[@id='body']/main[@id='content']/section[@class='container-xxl pt-5 pb-12']/div[@id='ContentPlaceHolder1_divTokenByLabels']/div[@class='tab-content']/div[@id='tab-3-0-content']/div[@class='card']/div[@class='table-responsive']/div[@id='table-subcatid-3-0_wrapper']/div[@class='d-flex flex-wrap align-items-center justify-content-between gap-3 p-4 text-dark']/div[@id='table-subcatid-3-0_paginate']/ul[@class='pagination pagination-sm mb-0']/li[@id='table-subcatid-3-0_next']/a[@class='page-link px-3']"
            try:
...
if __name__ == '__main__':
    ...
    ll.get_token_type("error_tokens_ETH_2.csv")
